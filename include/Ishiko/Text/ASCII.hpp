...
#ifndef GUARD_ISHIKO_CPP_TEXT_ASCII_HPP
#define GUARD_ISHIKO_CPP_TEXT_ASCII_HPP
...
namespace Ishiko
{
    ...
    public:
        ...
        static void Convert(std::string::const_iterator begin, std::string::const_iterator end, int16_t& number,
            Error& error) noexcept;
        static void Convert(const std::string& str, std::ios_base::fmtflags base, uint16_t& number,
            Error& error) noexcept;
